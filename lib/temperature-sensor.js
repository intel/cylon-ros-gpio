...
let TemperatureSensor = module.exports = function TemperatureSensor(opts) {
...
TemperatureSensor.prototype._celsius = function() {
  let val = this._analogVal;
  let r = (1023 - val) * 10000 / val;
  let t = 1 / (Math.log(r / 10000) / this._bValue + 1 / 298.15) - 273.15;
  ...
  let pub = this._rosNode.advertise("/celsius_" + this._name,
      "std_msgs/Int32", {
          queueSize: 1,
          latching: true,
          throttleMs: 1

...
var DirectPin = module.exports = function DirectPin(opts) {
...
DirectPin.prototype._digitalRead = function() {
  this.connection.digitalRead(this.pin, (err, data) => {
    ...
    var pub = this._rosNode.advertise("/digitalRead_" + this._name + "_result",
        "std_msgs/Int32", {
            queueSize: 1,
            latching: true,
            throttleMs: 1
...
DirectPin.prototype._analogRead = function() {
  this.connection.analogRead(this.pin, (err, data) => {
    ...
    const msg = new StdMsgs.Int32();
    msg.data = data;
    var pub = this._rosNode.advertise("/analogRead_" + this._name + "_result",
        "std_msgs/Int32", {
            queueSize: 1,
            latching: true,
            throttleMs: 1
